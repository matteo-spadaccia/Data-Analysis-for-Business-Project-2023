...
[code section: 11] !PARTIALLY REMOVED FROM VIEW!
_plots were removed_
```{r}
...
[code section: 19] !PARTIALLY REMOVED FROM SUMMARY!
_only one AIC model and two BIC models were saved since models were the same_
...
[code section: 25] !PARTIALLY REMOVED FROM SUMMARY!
_only the plot of the neural network was kept_
```{r}
plot(tempModel)
